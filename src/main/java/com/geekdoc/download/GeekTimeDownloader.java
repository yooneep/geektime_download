...
////                .filter(p -> p.compareTo("100617601") >= 0)
...
//        downloadChapter("100312101");
        Thread.sleep(10000000000L);
    }


    public static Map<String, String> downloadChapter(String cid) {
    ...
    public static void column(String cid) {
        ...
        boolean needmp3 = lowerCase.contains("kafka") ||
                ...
                lowerCase.contains("性能") ||
                lowerCase.contains("优化") ||
    ...
    private static void saveArticle(JSONObject obj, String mdPath, String mp3Path, int i, boolean needmp3, Map<String, String> idTitleMap) {
        try {
            ...
            if (!FileUtil.isExist(mdPath, fileName)) {
                ...
                Html2MDUtil.convert(article(id), mdPath + File.separator + finalFileName, true);
            }
    ...
    public static void saveMarkDown(JSONObject obj, String path, boolean needmp3) {
        try {
            ...
            if (!FileUtil.isExist(fileNamePath, fileName)) {
                ...
                Html2MDUtil.convert(article, fileNamePath + File.separator + fileName, true);
            }
            ...
            if (!FileUtil.isExist(fileNamePath2, mp3Name) && StringUtils.isNotBlank(audio_download_url) && needmp3) {
                HttpUtil.downloadFile(audio_download_url, fileNamePath2 + File.separator + mp3Name);
            }
        } catch (Exception e) {
            log.error("error ", e);
        }
